...
namespace TestCore
{
    public class TestHelpers
    {
        ...
        //Unhappy flow
        [Test]
        public void PasswordHelperShouldReturnFalseWhenPasswordDoesNotMatch()
        {
        ...
        [TestCase("user1", "IunRhDKa+fWo8+4/Qfj7Pg==.kDxZnUQHCZun6gLIE6d9oeULLRIuRmxmH2QKJv2IM08")]
        [TestCase("user3", "sxnIcZdYt8wC8MYWcQVQjQ==.FKd5Z/jwxPv3a63lX+uvQ0+P7EuNYZybvkmdhbnkIHA")]
        public void PasswordHelper_ShouldThrow_OnMalformedHash(string password, string passwordHash)
        {
